...
import { AiFillFire, AiOutlineUpload } from "react-icons/ai";
...
const Report = () => {
  ...
  const handleInputChange = ({ target }) => setForm({
	  ...form,
  ...
  const [sendComplain] = useMutation(createComplain, {
    onCompleted(data) {
		console.log(data);
      	alert('Tu queja fue creada exitosamente!')
    },
    onError(error) {
  ...
  const handleSubmit = () => {
	  if (!form.description) alert('Debes colocar una descripcion a la queja!');
	  if (!form.offeredPrice) alert('Debes colocar el precio de la queja!');
        ...
        <div className="report__content-form">
            ...
            <li className="card__item">
              ...
              <div className="card__item-info">
                <div className="info__card">
                  <VscLocation style={{ fontSize: "25px", color: "#db0a40" }} />
                  <p className="info__card-text">{station.town}</p>
                </div>
                <div className="info__card">
                  <AiFillFire style={{ fontSize: "25px", color: "#ffd400" }} />
          ...
          <div className="formulary">
            ...
            <div className="formulary__details">
              <h4 className="formulary__details-title">Detalles</h4>
